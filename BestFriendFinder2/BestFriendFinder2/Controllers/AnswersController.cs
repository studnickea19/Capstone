...
namespace BestFriendFinder2.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,AnswerContent,QuestionId")] Answer answer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,AnswerContent,QuestionId")] Answer answer)
        {
            if (ModelState.IsValid)
            {
