...
namespace BestFriendFinder2.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,QuestionContent,OptionOne,OptionTwo")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,QuestionContent,OptionOne,OptionTwo")] Question question)
        {
            if (ModelState.IsValid)
            {
